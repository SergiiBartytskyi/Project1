...
// Команди GIT-terminal:

// - git status(які зміни в коді);
// - git add .packege-json/ (додає файл .packege-json/ для коміту) або .(пробіл і крапка вибирає всі елементи і додає до коміту);
// - git commit -m 'your commit'(створює і дає назву коміту);
// - git push(робить коміт на Git - hub);
//
// - git branch name-branch (створює нову гілку name-branch);
// - git checkout name-branch (переходимо на гілку name-branch);
